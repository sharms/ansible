# Generated by Powerlevel10k configuration wizard on 2021-02-13 at 15:50 MST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 05135.
# Wizard options: awesome-fontconfig + powerline + python, large icons, classic, ascii,
# lightest, 24h time, 2 lines, disconnected, compact, fluent, instant_prompt=verbose.
